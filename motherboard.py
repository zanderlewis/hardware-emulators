...
class Motherboard:
    def __init__(self, cpu_bits: int = 16, ram_size: int = 512, gpu_memory: int = 1024, frame_buffer: int = 64, sound_buffer: int = 1024, debug: bool = False, hdd: bool = True, ssd: bool = True):
        ...
        self.network_card = NetworkCard(debug=debug)
